...
function renderSidebar(){
  ...
  const jobsNav=[
    ['jobdashboard','Dashboard'],['jobs','Jobs'],['finalsignoff','Final Sign Off'],['schedule','Install Schedule'],['cmmap','CM Schedule Map'],['weeklyrev','Weekly Revenue'],['invoicing','Invoicing'],['jobsettings','Settings'],
  ];
  const factoryNav=[
