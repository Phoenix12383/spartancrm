  ...
  if (tab === 'overview') {
    ...
    claims.forEach(function(cl,i){
      ...
      tabContent += '<div style="display:flex;align-items:center;gap:14px;padding:16px 20px;border-bottom:1px solid #f3f4f6">'
        ...
        +(cl.status==='pending'&&!cl.invoiceId&&!isZipClaim?'<button onclick="generateInvoiceForClaim(\''+job.id+'\',\''+cl.id+'\')" class="btn-r" style="font-size:10px;padding:4px 10px">\ud83d\udce8 Generate Invoice</button>':'')
