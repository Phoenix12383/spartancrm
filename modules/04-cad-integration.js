...
// CONTRACT.md (v3.1).
//
// The CAD runs as a same-origin iframe (cad.html served from the same CRM
// server), so origin checks use window.location.origin — no hard-coded URL.
// ═════════════════════════════════════════════════════════════════════════════
